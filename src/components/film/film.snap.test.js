...
import {mockSingleFilmData, mockFilmsListData, mockInitialStoreData, mockBoolean} from '../../test-mock';
      ...
      <redux.Provider store={store}>
        <Router history={history}>
          <Film
            ...
            onFetchFilm={jest.fn()}
            targetFilmIsLoading={mockBoolean}
            targetFilmIsLoadingError={mockBoolean}
          />
        </Router>
      </redux.Provider>
  );
